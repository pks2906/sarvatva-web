  ...
  return (
    <div className="h-screen">
        <div className="flex flex-col-reverse md:flex-row items-center md:ml-[72px] md:gap-x-6 text-[#131313]">
            <div className='flex flex-col justify-center w-[90%] md:w-[50%] md:px-14 mx-auto'>
                ...
                <p className='font-avenir font-light text-[16px] md:text-[20px] leading-[1.5rem] md:leading-9 my-4 md:mt-[28px] md:w-[75%] '>{para3}</p>
            </div>
            <div 
