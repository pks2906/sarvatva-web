    ...
    <div className="h-screen bg-[#111111]">
        <div className="flex flex-col md:flex-row items-center md:mx-[72px] md:py-8 md:gap-x-6">
            ...
            <div className='text-[#F5ECD8] flex flex-col justify-center w-[80%] mx-auto'>
                ...
                <p className='font-avenir my-[60px] md:w-[75%]'>Our creations are more than furniture; they are meticulously crafted invitations to experience an intrinsic sense of wholeness that resides in our inner world.</p>
                <Link to={'/about'}>
