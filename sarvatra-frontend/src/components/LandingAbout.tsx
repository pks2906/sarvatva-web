        ...
        <div className="flex flex-col md:flex-row md:justify-center md:items-center md:py-0 md:gap-x-24">
            ...
            <div className='flex h-[50vh]'>
                <div className='text-[#131313] flex flex-col justify-center w-[80%] mx-auto px-6 md:px-0'>
                    <h1 className='font-staatliches text-4xl md:text-6xl tracking-[0.125em] md:mt-0 md:mb-[8px]'>THE CRAFT OF WHOLENESS</h1>
                    <p className='font-avenir text-balance font-light md:text-[20px] mt-[10%] md:my-10 md:w-[75%] leading-[1.5rem] md:leading-9'>Our creations are more than furniture; they are meticulously crafted invitations to experience an intrinsic sense of wholeness that resides in our inner world.</p>
                    <Link to={'/about'}>
