...
const Navbar = () => {
  ...
  return (
    <div className={`font-staatliches tracking-[0.125em] fixed flex px-4 py-2 items-center justify-between top-0 left-0 w-full z-20 transition-colors duration-300 ${scrolled ? 'text-black bg-white bg-opacity-30 backdrop-blur-sm' : 'backdrop-blur-sm text-white'}`}>
      <Link to={'/'}>
