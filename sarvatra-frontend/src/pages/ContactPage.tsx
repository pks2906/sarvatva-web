    ...
    <div className="overflow-x-hidden">
      ...
      {/* <div className="h-screen">
        ...
        <div className="flex flex-col items-center mt-20 px-4 md:px-0">
          <h1 className="text-3xl md:text-4xl font-staatliches">Let's Connect</h1>
          <div className="flex flex-col md:flex-row my-8 text-lg md:text-xl font-avenir font-medium items-center">
            <label htmlFor="category" className="p-2">I am an: </label>
            <select 
              className="text-center px-4 py-2 border-t-2 border-b-2 border-black" 
              name="category" 
              id="userCategory" 
          ...
          {selectedOption !== "none" && (
            <>
              <div ref={formRef} className="grid grid-cols-1 md:grid-cols-2 my-8 gap-x-4 md:gap-x-24 gap-y-4 md:gap-y-10 w-full md:w-[90%]">
                ...
                <input type="text" placeholder="Last Name *" className="placeholder:text-[#393939] font-avenir font-light text-lg md:text-xl px-4 py-2 border-b border-[#393939]" />
                <input type="text" placeholder="Email *" className="placeholder:text-[#393939] font-avenir font-light text-lg md:text-xl px-4 py-2 border-b border-[#393939]" />
                <input type="text" placeholder="Phone No. *" className="placeholder:text-[#393939] font-avenir font-light text-lg md:text-xl px-4 py-2 border-b border-[#393939]" />
              </div>
              <div className="my-4 flex flex-col w-full md:w-[90%]">
                <h1 className="font-avenir text-lg md:text-xl py-2">Product of Interest</h1>
                <div className="grid grid-cols-2 md:flex md:space-x-10">
                  <div className="flex py-2 font-avenir font-light text-md md:text-lg">
              ...
              <div className="flex flex-col my-4 w-full md:w-[90%]">
                ...
                <div className="flex my-2 font-avenir font-light text-md md:text-lg">
