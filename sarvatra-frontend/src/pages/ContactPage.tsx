  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center mt-44">
        ...
        <div className="flex my-8 text-xl mx-2 font-avenir font-medium items-center">
        ...
        <div className="grid grid-cols-2 my-8 gap-x-24 gap-y-10 w-[90%] mx-[72px]">
        ...
        <div className="my-4 flex flex-col w-[90%] justify-start">
        ...
        <div className="flex flex-col my-4 w-[90%] justify-start">
          ...
          <div className="flex my-2 font-avenir font-light text-lg">
            ...
            <label htmlFor="notification" className="px-4">I would like to recieve the Sarvatva newsletter with updates, inspiration and more</label>
          </div>
          <button className="w-[100px] my-2 transition-all rounded-full font-avenir text-center hover:opacity-75 px-4 py-2 bg-black text-white">Submit</button>
        </div>
      </div>
    </div>
  )
